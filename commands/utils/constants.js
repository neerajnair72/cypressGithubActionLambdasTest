...
module.exports = {
    ...
    stage: {
        INTEGRATION_BASE_URL: "https://api.asad-env.dev.lambdatest.io/liis",
        //INTEGRATION_BASE_URL: "http://127.0.0.1:4449/liis",
        BUILD_BASE_URL: "https://api.asad-env.dev.lambdatest.io/automation/api/v1/builds/",
        BUILD_STOP_URL:"https://stage-api.lambdatest.com/api/v1/test/stop?buildId=",
        SESSION_URL:"https://api.asad-env.dev.lambdatest.io/automation/api/v1/sessions?build_id="
